...
#include "OldRepositoryApp.h"

bool OldRepositoryApp::connect_to_db(const string &host_name, const string &db_name, const string &user_name,
...
OldRepositoryApp::~OldRepositoryApp() {
...
void OldRepositoryApp::reload_data_from_db() {
...
vector<string> OldRepositoryApp::get_all_lists() {
...
vector<Task> OldRepositoryApp::get_tasks_from_list(const string &list_name) {
    return this->all_data_list[list_name];
}

void OldRepositoryApp::add_Task(const string &list_name, const Task &new_task) {
    auto lista_tabele = this->repository_database.tables();
